...
$file_msg = fopen("msg-volkswagen.db","a+");
$file_msg_read = file("msg-volkswagen.db");
...
<form name=formtext action=chat_volkswagen.php method=POST >
